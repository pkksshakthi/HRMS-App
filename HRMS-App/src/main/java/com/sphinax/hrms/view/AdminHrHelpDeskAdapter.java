...
public class AdminHrHelpDeskAdapter extends RecyclerView.Adapter<AdminHrHelpDeskAdapter.MyViewHolder> {
    ...
    public AdminHrHelpDeskAdapter(List<Ajax> ajaxList) {
        this.ajaxList = ajaxList;
    }

    @Override
    public AdminHrHelpDeskAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_admin_hrhelpdesk_update_item, parent, false);

        return new AdminHrHelpDeskAdapter.MyViewHolder(itemView);
    }
    ...
    public void onBindViewHolder(AdminHrHelpDeskAdapter.MyViewHolder holder, int position) {
        ...
        if (ajax.getReqDate().contains("/")){
            ...
            String[] date1 = ajax.getReqDate().split("/");
