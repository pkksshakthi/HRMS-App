...
class CalendarDayAdapter extends ArrayAdapter<Date> {
    ...
    public View getView(int position, View view, @NonNull ViewGroup parent) {
        ...
        if (dayIcon != null) {
            loadIcon(dayIcon, day,position,dayLabel);
            //dayLabel.setTextColor(mCalendarProperties.getEventDays().get(0).getColor());
            ...
            DayColorsUtils.setSelectedDayColors(mContext, dayLabel,mCalendarProperties.getTodayLabelColor());
    ...
    private void loadIcon(ImageView dayIcon, Calendar day, int position, TextView dayLabel) {
